...
# adjudicating words this subject attracts. Wings run on argument: Buffalo against
# Rochester, flat against drum, bone-in against boneless. Report the argument; never
# join it. "Not a real wing" is a thing people say, and it goes in quotation marks
# attributed to whoever said it, or it does not go in.
...
BANNED = re.compile(
    ...
    r"|real wings?|true wings?|proper wings?|real buffalo wings?|the real thing|sacrile\w+)\b", re.I)
