...
def main(argv: list[str]) -> int:
    ...
    pages = {
        ...
        "heat": ("How hot can you take it", "The ladder in the words makers actually print, and the one published Scoville figure — which lands below a jalapeño.", "the ladder", None,
                 [("1", "bottle with a Scoville number"), ("450", "SHU, Frank's Original"), ("30,000+", "SHU, a cayenne pepper")], "nashville-hot"),
        "vs": ("Settle it", "Two cities side by side out of their own records — cut, cook, sauce, dip, heat — and a sixteen-slot bracket you play in the browser.", "head to head", None,
               [("13", "styles"), ("16", "bracket slots"), ("0", "winners declared")], "rochester-breaded"),
        "never": ("Never Have I Ever: Wings", "Thirty lines. Tick what you have done, see what it says about you, paste it somewhere and tag somebody.", "tick them off", None,
                  [("30", "lines"), ("5", "bands"), ("1", "friend to tag")], "atomic"),
